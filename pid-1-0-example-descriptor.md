# PID 1.0 Example Descriptor

This is the example Force Feedback HID Report Descriptor from the USB.org document [Device Class Definition for Physical Interface Devices (PID) Version 1.0](http://www.usb.org/developers/hidpage/pid1_01.pdf) as a properly formatted array initialization block:
